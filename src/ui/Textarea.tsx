...
const field =
  ...
  'text-(--color-text) placeholder:text-(--color-text-subtle) resize-y ' +
  'transition-colors duration-(--duration-base) ease-(--ease-out-soft) ' +
  'disabled:cursor-not-allowed disabled:opacity-50'

type Props = Omit<ComponentPropsWithoutRef<'textarea'>, 'id'> & {
  label: string
...
/**
 * Multi-line text field, styled to match `Input` (same padding, border and
 * focus behaviour) with a real <label> and error/hint wired through
